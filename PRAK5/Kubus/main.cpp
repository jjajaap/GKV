...
void initRendering() {
	...
	Image* image2 = loadBMP("hutan.bmp");
	Image* image3 = loadBMP("kabut.bmp");
	Image* image4 = loadBMP("pantai.bmp");
	Image* image5 = loadBMP("tulip.bmp");
	Image* image6 = loadBMP("sakura.bmp");
